...
const MeetingScreen = () => {
  ...
  const showHideButton = ()=>{
    if(offerVisible){
      return(
        <div>
          <button onClick={createOffer} style={{margin:"40px 0 0 0px ",padding:"10px 20px",border:"none", background:"green",color:"white"}}>Call</button>
        </div>
      )
      ...
      return(
        <div>
          <button onClick={createAnswer} style={{margin:"40px 0 0 0px ",padding:"10px 20px",border:"none", background:"blue",color:"white"}}>Answer</button>
        </div>
      )
    }
  }
  ...
  return (
    ...
    <h1 >Naveen</h1>
				<div>
        <video   ref={myVideo} autoPlay={true} style={{ width: "300px",border:"1px solid", margin:"0px 20px" }} />
